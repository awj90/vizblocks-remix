...
import { barChartPreQuestions } from '~/constants'
...
export const action: ActionFunction = async ({ request }) => {
  ...
  const { error } = await supabaseAdmin.from('vlat').insert({ uid, graph_type: GRAPH_TYPES.barchart, score, test_type: 'pre' })
  console.log('>>>', error)
...
export default function BarChart() {
  return <VlatQuiz questions={barChartPreQuestions} type={GRAPH_TYPES.barchart} />
}
